package com.shail.camerarecording;
...
import com.itexico.camerarecording.R;
        ...
        public void onCheckedChanged(CompoundButton arg0, boolean isChecked) {
            ...
            if(isChecked){
                ...
                if(startRecording())
                    ...
                    Toast.makeText(CameraRecordActivity.this, "Some error in Camera !!", Toast.LENGTH_SHORT).show();
            }
			/*play player*/
            else{
...
//        Intent intent = new Intent(CameraRecordActivity.this, PlayVideo.class);
